...
namespace DVLD_Presentation.Tests
{
    public partial class frmListTestAppointments : Form
    {
        ...
        private void frmListTestAppointments_Load(object sender, EventArgs e)
        {
            ...
            _dtLicenseTestAppointments = clsTestAppintment.GetApplicationTestAppointmentsPerTestType(_LocalDrivingLicenseApplicationID, _TestType);

            dgvLicenseTestAppointments.DataSource = _dtLicenseTestAppointments;
            lbRecords.Text = dgvLicenseTestAppointments.Rows.Count.ToString();
