...
namespace DVLD_Presentation.Tests.Controls
{
    public partial class crlScheduleTest : UserControl
    {
        ...
        public clsTestTypes.enTestType _TestTypeID = clsTestTypes.enTestType.VisionTest;
        ...
        public void _LoadData(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            {
                lblRetakeAppFees.Text = clsApplicationType.GetApplicationTypeByID((int)clsApplication.enApplicationType.RetakeTest).Fees.ToString();
            ...
            if (_Mode == enMode.AddNew)
            {
                ...
                lblRetakeTestAppID.Text = "N/A";
                _TestAppointment=new clsTestAppintment();
            }
            else
            {
        ...
        {
            _TestAppointment = clsTestAppintment.Find(_TestAppointmentID);
        ...
        private bool _HandlePrviousTestConstraint()
        {
            ...
            switch (TestTypeID)
            {
                ...
                case clsTestTypes.enTestType.StreetTest:
                    ...
                    if (!_LocalDrivingLicenseApplication.DoesAttendTestType(clsTestTypes.enTestType.WrittenTest))
                    {
        ...
        private bool _HandleRetakeApplication() 
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                Application.CreatedByUserID = clsGlobal.CurrentUser.User_ID;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            _TestAppointment.CreatedByUserID = clsGlobal.CurrentUser.User_ID;
