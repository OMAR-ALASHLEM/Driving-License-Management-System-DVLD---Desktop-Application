...
namespace DVLD_Business
{
    public class clsDetainedLicense
    {
        ...
        public clsUser ReleasedByUserInfo
        {
            get
            {
                if (_ReleasedByUserInfo == null && this.ReleasedByUserID != -1)
                    _ReleasedByUserInfo = clsUser.Find(ReleasedByUserID);
        ...
        {
            this.DetainID = clsDetainedLicenseData.InsertDetainedLicense(this.LicenseID, this.DetainDate, this.FineFees, this.CreatedByUserID);
        ...
        public static bool IsLicenseDetained(int LicenseID) => clsDetainedLicenseData.IsLicenseCurrentlyDetained(LicenseID);

        public bool ReleaseDetainedLicense(int ReleasedByUserID, int ReleaseApplicationID) => clsDetainedLicenseData.ReleaseDetainedLicense(this.DetainID, ReleasedByUserID, ReleaseApplicationID);
